...
%\setcounter{chapter}{}
\vspace{-0.6 cm}
\chapter{Automatismes - Correction des exercices}
\thispagestyle{fancy}
...
\begin{corrBox}
On fait un 	\guillemets{produit en croix}

Tarif$=\dfrac{150\times 100}{30}=\dfrac{150}{30}\times 100=5\times 100=500$
\end{corrBox}
%\end{minipage} \hfill
%\begin{minipage}[c]{0.38\linewidth}
...
%\begin{minipage}[c]{0.48\linewidth}
	...
	\begin{enumMet}
		...
		\begin{corrBox}
			$p=\dfrac{n_S}{n_E}=\dfrac{150}{600}=\dfrac{1}{4}=0,25=25\%$		
		\end{corrBox}
		\item Calculer $p$ lorsque $n_S = 12$ et $n_E= 2 400$.\\
		Écrire le résultat sous la forme d'un pourcentage.
		\begin{corrBox}
			$p=\dfrac{n_S}{n_E}=\dfrac{12}{2400}=\dfrac{1}{200}=0,005=0,5\%$		
		\end{corrBox}
		\item Calculer $n_S$ lorsque $p = 0,09$ et $n_E= 250 000$.
		\begin{corrBox}
			$p=\dfrac{n_S}{n_E}\iff n_S=p\times n_E=0,09\times 250000=(0,1-0,01)\times 250000=25000-2500=22500$		
		\end{corrBox}
		\item Calculer $n_E$ lorsque $p = 0,30$ et $n_S = 3 000$.
		\begin{corrBox}
			$p=\dfrac{n_S}{n_E}\iff n_E=\dfrac{n_S}{p}=\dfrac{3000}{0,3}=\dfrac{30000}{3}=10000$		
		\end{corrBox}
		\item Calculer $n_E$ lorsque $p = 20 \%$ et $n_S = 6 000$.
		\begin{corrBox}
			$p=\dfrac{n_S}{n_E}\iff n_E=\dfrac{n_S}{p}=\dfrac{6000}{0,2}=\dfrac{60000}{2}=30000$		
		\end{corrBox}
		\item Sachant que $30 \%$ d'une somme $S$ vaut $600$ \EUR{}, calculer $S$.
		\begin{corrBox}
			On fait un 	\guillemets{produit en croix}
			
			S$=\dfrac{600\times 100}{30}=\dfrac{600}{30}\times 100=20\times 100=2000$
		\end{corrBox}
	\end{enumMet}
%\end{minipage} \hfill
%\begin{minipage}[c]{0.48\linewidth}
