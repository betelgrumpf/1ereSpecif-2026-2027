...
\rhead{\textcolor{red}{Correction - DM n$^{\circ}01$ - Croissance linéaire} - 02/05/2023}
			...
			\begin{minipage}[]{15cm}
				\begin{center}
					\LARGE{\rule{0.5cm}{0pt}\rule[-0.25cm]{0pt}{0.9cm}
						\textcolor{red}{Correction -DM n$^{\circ}01$ \\
						Croissance linéaire} 
					}
				\end{center}
			\end{minipage}
...
\begin{enumMet}
	...
	Combien y a-t-il de chèvres le mois suivant ? \corr{$58-6=52$}
	...
	Quelle valeur est relevée dix minutes plus tard? \corr{$27+4=31$}
\end{enumMet}
...
\begin{multicols}{2}
	...
	\begin{corrBox}
		$u(10)=\dfrac{4\times10+7}{3}=\dfrac{47}{3}$	
	\end{corrBox}
\end{enumMet}
\end{multicols}
...
\begin{multicols}{2}
	\begin{enumMet}
		\item $r=-7$ et $u(0)=3$.
		\begin{corrBox}
			$u(n)=u(0)+r\times n=3-7n$\\
			$u(4)=3-7\times 4=-25$	
		\end{corrBox}
		\columnbreak
		\item $r=-1,2$ et $u(0)=5,6$.
		\begin{corrBox}
			$u(n)=u(0)+r\times n=5,6-1,2n$\\
			$u(4)=5,6-1,2\times 4=0,8$	
		\end{corrBox}
	\end{enumMet}
\end{multicols}
...
\begin{enumMet}
	\item \begin{enumMet}
		...
		\begin{corrBox}
			revenu famille$=2150\times 12+2270\times 12+1500=54540$.\\
			quotient familial=$\dfrac{54540}{3}=18180$\\
			impot net$=(18180-10225)\times 11\%\times 3=2\ 625,15$	
		\end{corrBox}
		...
		\begin{corrBox}
			taux d'imposition moyen$=\dfrac{2\ 625,15}{54540}\times 100=4,81\%$	
		\end{corrBox}
	\end{enumMet}
	...
	\begin{enumMet}
		...
		\begin{corrBox}
			revenu famille$=3000\times 12+3300\times 12+6300=81900$.\\
			quotient familial=$\dfrac{81900}{3}=27300$\\
			impot brut$=(26070-10225)\times 11\%+(27300-26070)\times 30\%=1\ 742,95+369=2111,95$\\
			impot net=$2111,95\times 3=6335,85$	
		\end{corrBox}
		\item En déduire le taux d'imposition moyen.
		\begin{corrBox}
			taux d'imposition moyen$=\dfrac{6335,85}{81900}\times 100=7,73\%$	
		\end{corrBox}
	\end{enumMet}
\end{enumMet}
